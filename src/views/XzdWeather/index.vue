...
import TheSearch from '@/components/TheMain/TheSearch.vue'
import TheMore from '@/components/TheMain/TheMore.vue'
import TheCollect from '@/components/TheMain/TheCollect.vue'
